            ...
            <div class="card-body">
              ...
              @csrf
                <div class="mb-3">
                  ...
                  <input type="text" name="nrp" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value = "{{$mahasiswa->nrp}}">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" name="alamat" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value = "{{$mahasiswa->alamat}}">
                </div>
